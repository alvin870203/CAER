...
_C.DATASETS = CN()
_C.DATASETS.NAMES = ('AVEC')
_C.DATASETS.ROOT_DIR = ('./data/AVEC14/')

_C.DATALOADER = CN()
_C.DATALOADER.DATA_TYPE = 'DIMAGE'
# Number of data loading threads
_C.DATALOADER.NUM_WORKERS = 8
# Sampler for data loading
_C.DATALOADER.SAMPLER = 'PK_BATCH'
# Number of instance for one batch
_C.DATALOADER.NUM_INSTANCE = 12
_C.DATALOADER.IMS_PER_BATCH = 7
_C.DATALOADER.PRE_LOAD = False
...
_C.INPUT.CONTEXT_SIZE = [120, 160]
_C.INPUT.FACE_SIZE    = [112, 112]
_C.INPUT.PAD    = 5
